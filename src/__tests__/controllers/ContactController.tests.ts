...
describe('ContactService', () => {
  ...
  describe('insertContact', () => {
    it('should return validation error if data is invalid', () => {
      const invalidData = { firstName: 'Sabrina', lastName: 'Grey', phoneNumber: '(81) 8890-8432' }; //Ichoose to add a random brazilian number to show it only works with US numbers
    ...
    it('should create contact successfully when data is valid', () => {
      const validData = { firstName: 'Sasha', lastName: 'Barros', phoneNumber: '1234567890' };
  ...
  describe('findAllContacts', () => {
    it('should return all contacts', () => {
      const contacts = [
        ...
        { id: '2', firstName: 'Maria', lastName: 'Grace', phoneNumber: '1234567890' },
  ...
  describe('updateContact', () => {
    ...
    it('should return validation error if data is invalid', () => {
      const validationError = { status: 400, message: 'Invalid data' };
      const contactMockWithError = { firstName: '', lastName: ' name ', phoneNumber: '12890' };
